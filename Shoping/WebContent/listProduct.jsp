                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <c:forEach var="product" items="${listproduct}">
                                    <tr class="active">
                                     <td><c:out value="${product.accesories}"></c:out></td>
                                        <td><c:out value="${product.productname}"></c:out></td>
										<td><c:out value="${product.price}"></c:out></td>
										<td><c:out value="${product.batchno}"></c:out></td>
											<td><c:out value="${product.quantity}"></c:out></td>
											<%if(role.equals("Admin")){ %> 
											<td><a href="ProductController?action=delete&productId=<c:out value="${product.id}" />">Delete</a>|
				<td><a href="ProductController?action=edit&productid=<c:out value="${product.id}"/>">Update</a></td> <%} %>
                                    </tr>
                                    </c:forEach>
