                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered  table-hover table-striped" style="width:100%">
                                ...
                                <tbody>
									<c:forEach var="orderproduct" items="${myorderlist}">
										<tr>
										
											<td><c:out value="${orderproduct.orderno}"></c:out></td>
											<td><c:out value="${orderproduct.status}"></c:out></td>
											<td>
											<a href="OrderProductController?action=orderview&orderno=<c:out value="${orderproduct.orderno}"/>">View</a></td>
											
										<td>	<a href="OrderProductController?action=delete&orderno=<c:out value="${orderproduct.orderno}"/>">Delete</a></td>
									</c:forEach>
